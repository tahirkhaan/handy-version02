...
.box-skill:hover {
    background-color: rgba(0, 188, 225, 0.67);
}
         .box-skill p:hover{
           color: cadetblue;
         }
    ...
    margin-bottom: 97px;
          ...
          <div class="col-md-5 col-sm-10" style="height: auto; background-color: rgba(0, 0, 0, 0.71); border: 2px solid white; border-radius: 50px; padding-bottom: 20px;">
